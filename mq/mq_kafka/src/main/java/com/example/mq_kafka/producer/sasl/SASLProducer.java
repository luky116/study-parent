...
//        properties.put("sasl.jaas.config", "org.apache.kafka.common.security.scram.ScramLoginModule required username=\"writer\" password=\"writer\";"); // 设置用户名和密码

        KafkaProducer<String, String> producer = new KafkaProducer(properties);

        for (int i = 0; i < 1000000; i++) {
            ProducerRecord<String, String> record = new ProducerRecord<>(Consts.TOPIC, MessagePrefix + i);
