...
public class CheckerACL {
    ...
    public static void main(String args[]) {
        ...
        try {
            InputStream in = CheckerACL.class.getResourceAsStream("/config.properties");
            props.load(in);
            in.close();
        } catch (Exception e) {
        }
    ...
    public static void produceCheck() {
        ...
        props.setProperty("sasl.jaas.config", "org.apache.kafka.common.security.scram.ScramLoginModule required username=\"infrasre_kafka\" password=\"1c94f92243f832b5\";");
